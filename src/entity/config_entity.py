...
class DataIngestionConfig:
    ...
    extracted_data_filepath: str = os.path.join(
        root_dir, "extracted_data", "concrete_data.csv"
    )
    splitted_dataset_dir: str = os.path.join(root_dir, "splitted_dataset")
    train_dataset_filepath: str = os.path.join(
        splitted_dataset_dir, "train_dataset", "train.csv"
    )
    test_dataset_filepath: str = os.path.join(
        splitted_dataset_dir, "test_dataset", "test.csv"
    )
...
class DataTransformationConfig:
    ...
    transformed_train_filepath: str = os.path.join(
        root_dir, "transformed_data", "train.npy"
    )
    transformed_test_filepath: str = os.path.join(
        root_dir, "transformed_data", "test.npy"
    )
    tranformation_object_filepath: str = os.path.join(
        root_dir, "transformed_object", "preprocessor.pkl"
    )
